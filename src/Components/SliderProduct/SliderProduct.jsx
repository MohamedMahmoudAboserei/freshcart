...
export default function SliderProduct({ product }) {
    ...
    return <>
        <div className=" p-2 mb-4 group transition-all duration-300 hover:shadow-lg relative hover:rounded-2xl border-2 border-transparent hover:border-green-600">
