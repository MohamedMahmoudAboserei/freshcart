...
export default function Login() {
    ...
    return <>
        <div className='container pt-5 pb-10 w-2/3 mx-auto'>
            <h2 className='text-4xl font-bold py-6 text-emerald-500'>Login Now</h2>
            <form onSubmit={formik.handleSubmit} className=''>
                ...
                <div className='relative z-0 w-full mb-5 group'>
                    <input type={show ? 'text' : 'password'} name='password' id='password' value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} className='block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-emerald-900 dark:focus:border-emerald-500 focus:outline-none focus:ring-0 focus:border-emerald-600 peer' placeholder=' '/>
                ...
                <div className="max-md:space-y-8 md:flex justify-between items-center">
                    ...
                    <div className="max-md:space-y-8 md:flex items-center md:space-x-4">
                        <p>
                            <Link to='/forgetPassword' className='text-green-700 font-bold underline'>Forget password</Link>
                        </p>
